            ...
            <div className="row">
                ...
                <div className="checkout-left-data">
                    ...
                    <p className="user-details">
                        Keerthi Nagarajan(keerthiga4010@gmail.com)
                    </p>
                    <h4 className='mb-3'>Shipping Address</h4>
                    <form action="" className='d-flex gap-15 flex-wrap justify-cotent-between'>
                        <div className='w-100'>
                ...
                <div className='border-bottom py-4'>
                    ...
                    <div className='w-75 d-flex gap-10'>
                        <div className='w-25 position-relative'>
                            <span style={{"top":"-15px","right":"2px"}} className="badge bg-secondary text-white rounded-circle p-2 position-absolute">1</span>
                            <img className="img-fluid" src={watch} alt="product" />
                        </div>
                        <div>
                            <h5 className="total-price">rrwqr</h5>
                            <p className='total-price'>s / #jkkhkk</p>
                        </div>
                    </div>
                    <div className='flex-grow-1'>
